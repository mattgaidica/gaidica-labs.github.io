...
function get_atlas($ap, $ml, $dv, $dot_px) {
  ...
  $file = fopen('mouse-brain-atlas.csv', 'r');
  ...
  $coronal_image = "images/Mouse_Brain_Atlas_$csv_coronal_key.jpg";
  ...
  $sagittal_image = "images/Mouse_Brain_Atlas_$csv_sagittal_key.jpg";
