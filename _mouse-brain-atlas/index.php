  ...
  <body>
    ...
    <div class="container marketing">
      <div style="text-align:center;" class="featurette">
        <h2 class="featurette-heading">Mouse Brain Atlas</h2>
      </div>
    </div>
    ...
    <div style="text-align:center;margin-left:0;" class="row">
      <div class ="span12">
        ...
        <p class="try"><small><a href="/rat-brain-atlas">Rat Brain Atlas</a> &bull; <a href="?ml=2.5&ap=-.4&dv=3.2">CPu caudate putamen (striatum)</a></small></p>
      </div>
    </div>
    ...
    <div style="text-align:center;" class="row">
      <p><strong>Atlas Source:</strong> Paxinos, George, and Keith B.J. Franklin. <em>The mouse brain in stereotaxic coordinates: hard cover edition.</em> Access Online via Elsevier, 2001.</p>
